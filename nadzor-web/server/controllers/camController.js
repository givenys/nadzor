...
exports.updateFrame = (deviceId, buffer) => {
...
exports.latestFrames = latestFrames;
...
exports.receiveFrame = (req, res) => {
    ...
    exports.updateFrame(deviceId, req.body);
...
exports.getCameras = async (req, res) => {
    try {
        const result = await db.query(`
            SELECT d.id, d.name AS device_name, e.full_name AS employee_name 
            FROM devices d 
